...
class DiscreteChoiceAnalyzer:
    ...
    def validate_data(self):
        """Check for data anomalies, e.g., price-choice correlations."""
    ...
    def fit_model(self, group=None):
        X_cols = [
            ...
            'Adv_Feat_TempMon', 'Adv_Feat_Health'
        ]
        ...
        try:
            ...
            if not self.model.mle_retvals['converged']:
                print("nm failed to converge, trying bfgs...")
    ...
    def plot_utilities(self, custom_labels=None):
        ...
        default_labels = {
            ...
            'Adv_Feat_TempMon': 'Terminal Temp Monitoring',
