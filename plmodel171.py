...
class DiscreteChoiceModel:
    ...
    def balance_data(self, df, market, target):
        ...
        if market in ['Punjab', 'Maharashtra', 'Gujarat', 'South']:
            ...
            if n_samples < 10:  # Minimum threshold for balancing
    ...
    def fit(self, df, target='Chosen', features=None):
        ...
        for market in self.markets:
            ...
            if len(market_df) < 100:  # Minimum threshold for model fitting
        ...
        for market in self.markets:
            if market not in self.models:  # Skip if already marked insufficient
                continue
